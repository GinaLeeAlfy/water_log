...
const Logger = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <NavBar />
      <section className="prose container flex flex-col items-center border-2 border-green-700 text-center">
        <h2>
          {consumed}
          {" out of "} {goal}
          {!isMetricUnits ? "oz" : "mL"}
        ...
        <form
          onSubmit={(e) => {
            e.preventDefault();
            setConsumed(consumed + adding);
          }}
          className="w-fit space-y-3 rounded border-2 border-blue-400 p-4"
        >
          ...
          <fieldset className="flex flex-col items-center gap-2">
            ...
            <div>
              <input
                ...
                id="drank"
                onChange={(e) => {
                  setAdding(Number(e.target.value));
                }}
                className="w-10 text-end"
              />
